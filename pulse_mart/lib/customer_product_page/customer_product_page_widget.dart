...
import 'customer_product_page_model.dart';
export 'customer_product_page_model.dart';

class CustomerProductPageWidget extends StatefulWidget {
  const CustomerProductPageWidget({super.key});

  @override
  State<CustomerProductPageWidget> createState() =>
      _CustomerProductPageWidgetState();
}

class _CustomerProductPageWidgetState extends State<CustomerProductPageWidget> {
  late CustomerProductPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CustomerProductPageModel());
  }
